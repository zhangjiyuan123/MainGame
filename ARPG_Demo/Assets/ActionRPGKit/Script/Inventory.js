...
function CheckItem(id : int , type : int , qty : int) : boolean{
	var having : boolean = false;
	var geta : boolean = false;
...
function FindItemSlot(id : int) : int{
	var geta : boolean = false;
...
function FindEquipmentSlot(id : int) : int{
	var geta : boolean = false;
...
function RemoveItem(id : int , amount : int) : boolean{
	var haveItem : boolean = false;
	var slot : int = FindItemSlot(id);
...
function RemoveEquipment(id : int) : boolean{
	var haveItem : boolean = false;
	var slot : int = FindEquipmentSlot(id);
	if(slot < equipment.Length){
		equipment[slot] = 0;
		AutoSortEquipment();
		haveItem = true;
